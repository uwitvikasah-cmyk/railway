...
<div class="modal-overlay" id="applyModal">
  <div class="modal">
    <button class="close-btn" onclick="document.getElementById('applyModal').classList.remove('open')">✕</button>
    <h2>Apply for <span id="modalJobTitle"></span></h2>
    <div id="applyForm">
      <input type="text" placeholder="Full Name" id="appName" required/>
      <input type="email" placeholder="Email Address" id="appEmail" required/>
      <input type="tel" placeholder="Phone Number (e.g. 08012345678)" id="appPhone"/>
      <input type="url" placeholder="LinkedIn / Portfolio URL (optional)" id="appLink"/>
